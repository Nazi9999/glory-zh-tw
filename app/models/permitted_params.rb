class PermittedParams < Struct.new(:params, :user)
  ...
  def question_attrs
    [:text, :dic_id, :q_type, :ans, :q_class, :q_item, :note, members_attributes: [:id, :question_id, :option_id, :code, :is_correct, :note, :option_class, :_destroy], options_attributes: [:id, :content, :o_class, :_destroy]]
  end
